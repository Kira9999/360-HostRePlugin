...
public class MainActivity extends BasePermissionActivity implements View.OnClickListener {
    ...
    final String FILE_NAME_PLUGIN_1 = "plugin3.apk";
    final String FILE_NAME_PLUGIN_2 = "plugin2.apk";
    final String FILE_NAME_PLUGIN_3 = "yellowduck.apk";
...
//        }
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                fileNames.add(FILE_NAME_PLUGIN_3);
    ...
    public void onClick(View v) {
        ...
        } else if (v.getId() == R.id.btn_go_plugin_activity2) {// 跳转插件Activity并且有返回值
            Intent intent = new Intent();
            intent.setComponent(new ComponentName(P_Constants.ALIAS_PLUGIN_1, P_Constants.PACKAGE_NAME_PLUGIN_1 + ".MainActivity"));
            startActivity(intent, true);
